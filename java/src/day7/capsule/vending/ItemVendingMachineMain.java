...
//		System.out.println(MyItem.name); // nullpointerException -> myItem의 주소에 아무것도 없음. 
		...
		System.out.println("구매한 상품의 이름은 : " + mySecondItem.getName());
		System.out.println("구매한 상품의 가격은 : " + mySecondItem.getPrice());
		System.out.println("구매한 상품의 수량은 : " + mySecondItem.getStock());
		
		vendingMachine.printStock();
		
		Item myThirdItem = vendingMachine.pressItemButton("밀키스", 1);
		System.out.println("구매한 상품의 이름은 : " + myThirdItem.getName()); // 상품이 0보다 작아 null이 반환됨.
		System.out.println("구매한 상품의 가격은 : " + myThirdItem.getPrice());
		System.out.println("구매한 상품의 수량은 : " + myThirdItem.getStock());
