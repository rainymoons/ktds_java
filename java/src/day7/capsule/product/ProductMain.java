...
public class ProductMain {
	...
	public static void main(String[] args) {
		...
		//재고 출력
		System.out.println("박카스 : " + productOrder.bakkas.getProductQuantity() + "개 "+ "\n" + "몬스터 : " + productOrder.monster.getProductQuantity() + "개" + "\n" + "핫식스 : " 
		+ productOrder.hotSix.getProductQuantity() + "개 " + "\n" + "밀키스 : " + productOrder.milkis.getProductQuantity() + "개");
